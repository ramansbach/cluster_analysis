...
latex_documents = [
  ('index', 'clustering.tex', 'clustering Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'clustering', 'clustering Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'clustering', 'clustering Documentation',
   'Ariel Rokem', 'clustering', 'One line description of project.',
   'Miscellaneous'),
]
